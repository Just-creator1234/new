...
//   <button
//     onClick={onClick}
//     className={`w-full flex items-center space-x-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors ${className}`}
//   >
//     {icon}
//     <span>{label}</span>
//   </button>
...
//     <button
//       onClick={onClick}
//       className={`block w-full text-left px-3 py-3 hover:bg-gray-50 transition-colors border-b border-gray-100 last:border-b-0 border-l-2 ${getTypeColor()}`}
//     >
...
//                       setIsOpen(false);
//                     }}
//                     className="w-full flex items-center space-x-3 px-4 py-3 text-sm text-blue-600 hover:bg-blue-50 transition-colors"
//                   >
...
//             <button className="hidden md:block p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
...
//             {showWriterMenu && <AccountDropdown menuRef={menuRef} />}
//           </div>
//         </div>
//       </div>
//     </header>
