        ...
        <div className="lg:col-span-3">
          ...
          {activeTab === "advanced" && (
            <div className="space-y-6">
              ...
              {post.visibility === "password-protected" && (
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-700">
                    Password
                  </label>
              ...
              <div className="space-y-3">
                ...
                <label className="flex items-center gap-2 text-gray-700">
                  <input
                    ...
                    checked={post.sticky}
                    onChange={(e) =>
                      setPost({ ...post, sticky: e.target.checked })
                    }
                    className="rounded border-gray-300 text-orange-600 focus:ring-orange-500"
                  />
                  Sticky (pin to top)
                ...
                <label className="flex items-center gap-2 text-gray-700">
                  <input
                    ...
                    onChange={(e) =>
                      setPost({ ...post, allowComments: e.target.checked })
                    }
                    className="rounded border-gray-300 text-orange-600 focus:ring-orange-500"
                  />
                  Allow comments
                ...
                <label className="flex items-center gap-2 text-gray-700">
                  <input
                    type="checkbox"
                    checked={post.allowSharing}
                    onChange={(e) =>
                      setPost({ ...post, allowSharing: e.target.checked })
                    }
                    className="rounded border-gray-300 text-orange-600 focus:ring-orange-500"
                  />
                  Allow sharing
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  <input
                    value={post.newCoAuthor}
                    onChange={(e) =>
                      setPost({ ...post, newCoAuthor: e.target.value })
                    }
                    onKeyDown={(e) => {
                      if (e.key === "Enter" && post.newCoAuthor.trim()) {
                        setPost({
                          ...post,
                          coAuthors: [
                            ...post.coAuthors,
                            post.newCoAuthor.trim(),
                          ],
                          newCoAuthor: "",
                        });
                      }
                    ...
                    >
                      ...
                      <button
                        onClick={() =>
                          setPost({
                            ...post,
                            coAuthors: post.coAuthors.filter(
                              (a) => a !== author
                            ),
                          })
                        }
              ...
              <div>
                ...
                <textarea
                  value={post.editorNotes}
                  onChange={(e) =>
                    setPost({ ...post, editorNotes: e.target.value })
                  }
                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 bg-white"
                  rows={3}
                />
              ...
              <div>
                ...
                <textarea
                  value={JSON.stringify(post.customFields, null, 2)}
                  onChange={(e) => {
                    try {
                      setPost({
                        ...post,
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 bg-white font-mono text-sm"
                  rows={5}
                />
              </div>
            </div>
