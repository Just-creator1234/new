...
//                       </span>
//                     </div>
//                     <h2 className="text-2xl font-bold text-white mb-2 break-words whitespace-normal">
//                       {latestNews[0].title}
//                     </h2>
//                     <p className="text-white/90 line-clamp-2 break-words whitespace-normal">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {latestArticles.length > 0 && (
            <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-lg">
              ...
              {/* Updated List Layout with Larger Thumbnails and Spacing */}
              <div className="space-y-8">
                {latestArticles.map((article) => (
                  <div key={article.id} className="group">
                    <Link href={`/${article.slug}`} className="block">
                      <div className="flex flex-col sm:flex-row gap-6 p-4 rounded-xl hover:bg-white/90 transition-colors duration-200 border border-transparent hover:border-gray-200">
                        {/* Larger Thumbnail */}
                        <div className="sm:w-2/5">
                          {article.coverImage ? (
                            ...
                            <div className="aspect-video rounded-lg flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 border border-dashed border-gray-300">
                              <ImageOff className="w-10 h-10 text-gray-400" />
                            </div>
                          )}
                        </div>
